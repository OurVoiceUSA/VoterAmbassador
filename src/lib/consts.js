...
export const API_LOCAL = (process.env.NODE_ENV === 'development');
export const API_SSL = process.env.REACT_APP_API_SSL;
export const AUDIANCE = process.env.REACT_APP_AUDIANCE?process.env.REACT_APP_AUDIANCE:'';
export const BASEURI = process.env.PUBLIC_URL;
